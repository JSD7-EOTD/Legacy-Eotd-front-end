    ...
    <div className="md:flex">
      ...
      <div className=" p-6 flex flex-col gap-8 font-semibold text-zinc-600 md:w-1/2 md:flex md:place-content-center h-[100vh]">
        ...
        <div className="flex flex-col items-center gap-8 text-zinc-400 text-sm">
          <div>
            <input type="checkbox" />
            By creating an account means you agree to the<a href="" className="text-black">Terms</a>
            and<a href="" className="text-black">Conditions</a>, and our<a href="" className="text-black">
              Privacy Policy.</a>
          </div>
          ...
          <div>
            <p>
              ...
              <a href="/d_login.html" className="text-black">Sign Up</a>
            </p>
          </div>
        </div>
      </div>
